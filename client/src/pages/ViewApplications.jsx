        ...
        <table className='w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            <tr className='border-b'>
              <th className='py-2 px-4 text-left max-md:hidden' >#</th>
          ...
          <tbody>
            {viewApplicationsPageData.map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                <td className='py-2 px-4 border-b text-center max-md:hidden'>{index + 1}</td>
                ...
                <td className='py-2 px-4 border-b max-md:hidden'>{applicant.location}</td>
