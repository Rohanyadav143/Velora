...
const ApplyJob = () => {
  ...
  return jobData ? (
    <>
      <Navbar />
      <div className="min-h-screen flex flex-col py-10 conatiner px-4 2xl:px-20 mx-auto">
        <div className="bg-white text-black rounded-lg w-ful">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl">
            <div className="flex flex-col md:flex-row items-center">
              <img
                className="h-24 bg-white rounded-lg p-4 mr-10 max-md:mb-4 border"
              ...
              <div className="text-center md:text-left text-neutral-700">
                ...
                <div className="flex flex-row flex-wrap max-md:justify-center gap-y-2 gap-8 ml-1 items-center text-gray-600 mt-5">
                  <span className="flex item-center gap-1">
                    <img src={assets.suitcase_icon} alt=""></img>
                  ...
                  <span className="flex item-center gap-1">
                    <img src={assets.money_icon} alt=""></img>
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center">
              ...
              <p className="mt-4 text-gray-600 mr-5">
