            ...
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500'>
                ...
                {state  === "Sign Up" && isTextDataSubmited ? <>
                    <div className='flex items-center gap-4 my-10'>
                        <label htmlFor='image'>
                            <img className='e-16 rounded-full cursor-pointer h-16 w-16' src={image ? URL.createObjectURL(image) : assets.upload_area} alt=''/>
                ...
                {state !== 'Login' && (
                    ...
                    <div className='border px-4 py-2 flex items-center gap-2 rounded-full mt-5'>
                        ...
                        <input className='outline-none text-sm' onChange={e=>setEmail(e.target.value)} value={email} type="email" placeholder='Email id' required></input>
                    </div>
